...
### 0.7.20260311
  ...
  * CHANGED: package updates (go-bing, dns)
  * CHANGED: restructure check administrations
  * CHANGED: make check stoppable (mostly in the GUI)
  * NEW: add free text filtering in GUI
  * CHANGED: add JSON(L) output in CLI and downloadable in GUI
  * NEW: configureable host:port for server behind the GUI
  * CHANGED: updated Quad9's IP list
...
### 0.6.20250714
  ...
  * NEW: GUI (start with `-gui`) based on [https://github.com/robert-kisteleki/mingobingo](mingobingo)
